...
.mousePressed(()=>{if(this.testar(this.colorpigment.value(),0)==true){this.Result("+","Color",this.testar(this.lightcolor.value(),2))}})
...
if(x==0){return true};if(x==1){return ("rgba("+this.c+",1)")};if(x==2){return this.n}
    ...
    this.t=t.substring(0,2);t=t.substring(this.t.length);if(this.t==""){return false};if(this.testHexa(this.t[0],1)===false||this.testHexa(this.t[1],0)===false){return false};this.n.push(this.testHexa(this.t[0],1)+this.testHexa(this.t[1],0))
    this.t=t.substring(0,2);t=t.substring(this.t.length);if(this.t==""){return false};if(this.testHexa(this.t[0],1)===false||this.testHexa(this.t[1],0)===false){return false};this.n.push(this.testHexa(this.t[0],1)+this.testHexa(this.t[1],0))
    if(t!=""){this.t=t.substring(0,2);t=t.substring(this.t.length);if(this.t==""){return false};if(this.testHexa(this.t[0],1)===false||this.testHexa(this.t[1],0)===false){return false};this.n.push((1/255)*(this.testHexa(this.t[0],1)+this.testHexa(this.t[1],0)))}
...
return this.transform(x,[this.testNCol(2,this.n[0]),this.n[1],this.n[2]],"NCol")
  ...
  if(t=="red"){if(x==0){return true};if(x==1){return "rgba(255,0,0,1)"};if(x==2){return [255,0,0,1]}}
  else if(t=="blue"){if(x==0){return true};if(x==1){return "rgba(0,0,255,1)"};if(x==2){return [0,0,255,1]}}
  else if(t=="green"){if(x==0){return true};if(x==1){return "rgba(0,255,0,1)"};if(x==2){return [0,255,0,1]}}
  else if(t=="yellow"){if(x==0){return true};if(x==1){return "rgba(255,255,0,1)"};if(x==2){return [255,255,0,1]}}
  else if(t=="pink"){if(x==0){return true};if(x==1){return "rgba(255,0,128,1)"};if(x==2){return [255,0,128,1]}}
  else if(t=="orange"){if(x==0){return true};if(x==1){return "rgba(255,128,0,1)"};if(x==2){return [255,128,0,1]}}
  else if(t=="brown"){if(x==0){return true};if(x==1){return "rgba(139,69,19,1)"};if(x==2){return [139,69,19,1]}}
  else if(t=="magenta"){if(x==0){return true};if(x==1){return "rgba(255,0,255,1)"};if(x==2){return [255,0,255,1]}}
  else if(t=="cyan"){if(x==0){return true};if(x==1){return "rgba(0,255,255,1)"};if(x==2){return [0,255,255,1]}}
  else if(t=="black"){if(x==0){return true};if(x==1){return "rgba(0,0,0,1)"};if(x==2){return [0,0,0,1]}}
  else if(t=="gray"){if(x==0){return true};if(x==1){return "rgba(128,128,128,1)"};if(x==2){return [128,128,128,1]}}
  else if(t=="white"){if(x==0){return true};if(x==1){return "rgba(255,255,255,1)"};if(x==2){return [255,255,255,1]}}
  else{return false}
  }
}
Result(x,ct,c1){
...
if(ct=="Light"){
  ...
  cor.Color.N[0]=Number((L[0]+c1[0]));if(cor.Color.N[0]<0){cor.Color.N[0]=0};if(cor.Color.N[0]>255){cor.Color.N[0]=255}
  cor.Color.N[1]=Number((L[1]+c1[1]));if(cor.Color.N[1]<0){cor.Color.N[1]=0};if(cor.Color.N[1]>255){cor.Color.N[1]=255}
  cor.Color.N[2]=Number((L[2]+c1[2]));if(cor.Color.N[2]<0){cor.Color.N[2]=0};if(cor.Color.N[2]>255){cor.Color.N[2]=255}
  cor.Color.N[3]=Number((L[3]+c1[3]-1));if(cor.Color.N[3]<0){cor.Color.N[3]=0};if(cor.Color.N[3]>1){cor.Color.N[3]=1}
...
if(t=="HSL"){//(cor,a cada 60, aumenta 255 no ppproximo, depois subtrai no anterior e repete; 0%=(128,128,128)-100%=cor normal; 0%=(0,0,0)-50%=cor normal-100%=(255,255,255))
  this.H=[]
  //H
if(n[0]==0||n[0]==360){this.H=undefined}
